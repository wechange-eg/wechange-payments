...
class Payment(DebitPeriodMixin, models.Model):
    ...
    # this is now called "Order ID" so it is not confused with other vendor naming conventions
    internal_transaction_id = models.CharField(_('Order Id'), max_length=50,
        help_text='An Order Id for the payment generated by us')
